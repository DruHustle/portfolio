        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg">
          ...
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-4 space-y-2">
            ...
            {isDevelopment && error && (
              <div className="mt-4 pt-4 border-t border-slate-700/50">
                <p className="text-xs text-purple-400 font-mono break-words">
                  {error.message}
                </p>
              </div>
            )}
